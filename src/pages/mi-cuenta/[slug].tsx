      ...
      <div className='max-w-[1200px] py-10 mx-auto'>
        <div className=''>
          ...
          <div className='grid grid-cols-3 mt-5'>
            <article className='max-w-[280px] p-5 bg-white rounded-xl shadow-lg'>
              ...
              <div className='flex justify-center'>
                <button className='bg-[#a02e2b] w-full text-white pb-2 pt-1 mt-5  px-4 hover:opacity-75 transition-all duration-500 rounded-md'>
                  Registrar
                </button>
              </div>
