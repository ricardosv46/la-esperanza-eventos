                  ...
                  <div className="grid h-auto grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="relative">
                      <InputFloat
                        type="text"
                        label={
                          values.tipoComprobante === 'Factura' ? 'RUC' : 'DNI'
                        }
                        name="documento"
                    ...
                    <div className="flex gap-2 justify-start items-center ">
                      ...
                      <p className="text-md text-[#F0AC42] font-bold">
                        Compra Segura
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="grid  grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <p className="text-xs leading-[11px] px-1">
                      Llene sus datos correctamente, con ellos creará un
                      registro con su cuenta para generar sus boletos para el
                      evento.
                    </p>
