...
const CheckOut = () => {
  const { documento, nombres, apellidos, celular, email, onChange } = useForm({
    documento: '',
    nombres: '',
    apellidos: '',
    celular: '',
      ...
      <div className='max-w-[1000px] w-full mx-auto p-10 bg-white shadow-xl rounded-xl'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-3 mt-8'>
          <div className='grid  grid-cols-1 sm:grid-cols-2 gap-2'>
            <select className='rounded-md h-[50px] px-3 border border-gray-300 ' name=''>
            ...
            <InputFloat type='ruc' label='Nro Documento' name='documento' value={documento} onChange={onChange} />
            ...
            <InputFloat type='celular' label='Celular' name='celular' value={celular} onChange={onChange} />

            <InputFloat type='email' label='Email' name='email' value={email} onChange={onChange} />
            ...
            <p className='text-xs leading-[11px] px-1'>
              Llene sus datos correctamente, con ellos creará un registro con su cuenta para generar sus boletos para el
              evento.
            </p>
