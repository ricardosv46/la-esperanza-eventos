              ...
              <div className=' w-full   flex items-center '>
                <div className='flex flex-col md:items-start gap-5 '>
                  ...
                  <p className='text-justify px-0 text-[#505050] font-bold'>
                    La Plaza de Toros La Esperanza fue inaugurada en el año 2009, siendo un ruedo sin graderías, el
                    punto de encuentro y lugar donde se incubó la nueva generación de aficionados prácticos, llenando
                    aquel año cada sábado con encerronas taurinas y gratos momentos de confraternidad. <br />
                    <br />
                    Buscando ser la casa del taurino de buena voluntad, se amplió en una primera etapa dotándola de un
                    callejón que permita el buen desarrollo de un festejo taurino y cómodas butacas en las tres filas
                    más cercanas al ruedo. Bajo esa configuración se albergaron las primeras corridas de toros formales
                    brindando un lugar muy especial a la afición taurina, que fue creando el ambiente y la identidad de
                    La Esperanza, en un espacio de campo con sabor criollo y fraternidad. <br />
                    <br />Y así, la necesidad de albergar más afición tras vivir esta pandemia hizo que la plaza
                    creciera mucho más, contando ahora con un tendido fijo de 12 filas y 5 palcos, capaz de albergar en
                    su totalidad cerca de 3000 personas, manteniendo su coqueta identidad y esa personalidad que invita
          ...
          <div className=' w-full flex-1 flex items-center  bg-primarydark'>
            <div className='flex flex-col md:items-end gap-10'>
              ...
              <p className='text-gray-100 text-lg lg:ml-7 md:text-right '>
                Las fiestas de toros es considerada un arte que sólo los entendidos pueden apreciar. A partir de las
                reflexiones del filósofo Francis Wolff, se emprende un recorrido histórico y antropológico para mostrar
          ...
          <div className='grid pb-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-20 text-center text-[#505050] '>
            <article
              ...
              <div className='py-5 px-5'>
                ...
                <p className=' text-justify  text-[14px] text-[#777] my-3'>
                  Ingresa La Mitideología La tauromaquia, como muchos otros festejos taurinos, se encuentran entre el
                  rito y el juego; entre el espectáculo y la hazaña
                </p>
            ...
            <article
              ...
              <div className='py-5 px-5'>
                ...
                <p className=' text-justify  text-[14px] text-[#777] my-3'>
                  Ingresa LA TAUROMAQUIA La tauromaquia, como muchos otros festejos taurinos, se encuentran entre el
                  rito y el juego; entre el espectáculo y la hazaña
                </p>
                <p className='text-primary text-left text-xs font-semibold'>Leer más »</p>
              </div>
            ...
            <article
              ...
              <div className='py-5 px-5'>
                ...
                <p className='text-xs text-left text-[#adadad]'>8 de abril de 2022</p>
                <p className=' text-justify  text-[14px] text-[#777] my-3'>
                  Ingresa FESTEJOS TAURINOS Con los primeros rayos del sol un anciano señala con un par de plumas de
                  águila hacia el oriente. En su
                </p>
                <p className='text-primary text-left text-xs font-semibold'>Leer más »</p>
              </div>
            </article>
