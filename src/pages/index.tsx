      ...
      >
        <div className="w-full lg:w-1/2">
          ...
          <p className="text-white font-semibold text-md lg:px-5 pt-10">
            ¡Renovación, entrega, arte y clase en esta Feria de la Esperanza!
            Abónate y disfruta una gran feria, donde seremos testigos de la
            nueva generación de grandes toreros, así como el relevo generacional
            de la torería peruana.
          </p>
        </div>
        <div className="w-full lg:w-1/2">
          ...
          <div className=" w-full flex-1 flex items-center  bg-primarydark">
            <div className="flex flex-col md:items-end gap-10">
              ...
              <p className="text-gray-100 text-lg lg:ml-7 md:text-right ">
                Descubre nuestros próximos carteles y compra tus entradas para
                vivir al máximo la fiesta en La Esperanza
              </p>
              <button
                onClick={() => navigate.push("eventos")}
                style={{ boxShadow: "-8px 6px 13px 0px rgba(0,0,0,0.42)" }}
