...
const Eventos = () => {
  ...
  const isDisableAbono = moment().isBetween(moment(fechaI), moment(fechaF))
    ? false
    : true;
        ...
        <div className=" flex flex-col md:flex-row justify-between max-w-[1200px] gap-x-5 items-center  mx-auto px-5 pt-10">
          <div className="">
            ...
            <p className="text-base w-full max-w-[530px] mt-5 text-justify">
              ...
              tus abonos con un {abono.descuento}% de descuento y disfruta de la
              mejor fiesta taurina de la temporada.
            </p>
          </div>
          <div className="mt-5">
