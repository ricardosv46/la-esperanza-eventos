        ...
        <Container bgColor='backdrop-blur-lg' className=' pt-36 pb-5'>
          <main className='lg:px-5 flex flex-col lg:flex-row gap-5'>
            <div className="flex flex-col gap-y-5 pb-6">
              <section className='lg:relative w-full  rounded-lg  gap-5  flex flex-col bg-white pb-5'>
              ...
              <article className='w-full bg-white rounded-lg  p-5 lg:p-9 flex flex-col gap-5 border shadow-lg'>
