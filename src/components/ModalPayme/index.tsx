...
const PAYME_KEY_PRD = 'g51BswhZXrQzyPH2EMl1KmDrBK0li7bxEhpB0YLUGNGdlJbIWkGj3fiLqIeFVUe2'
const PAYME_KEY_DEV = 'FsVVX37w7ZSK1HNQ8NXxDhFEFLXjREorode1sokWZzz2ZahPfG1F35DpOd1miSuh'
					...
					<Modal
						...
						<div className='p-3 bg-white rounded'>
							<div className='grid mb-5 place-items-center'>
								<Image alt='logo' width={180} height={60} className='filter-logo' src='/imgs/logos/logo.png' />
							</div>
							{isOpen && <div id='payme' />}
