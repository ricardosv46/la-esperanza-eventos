        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
          ...
          <div className='relative'>
            ...
            {errors.ruc && touched.ruc ? (
              <p className='text-red-500 leading-5 absolute -bottom-5 text-sm px-1 '>{errors.ruc}</p>
            ) : null}
            {errors.dni && touched.dni ? (
              <p className='text-red-500 leading-5 absolute -bottom-5 text-sm px-1 '>{errors.dni}</p>
            ) : null}
          </div>
